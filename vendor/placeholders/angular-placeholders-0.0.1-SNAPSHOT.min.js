angular.module("placeholders", ["placeholders.img", "placeholders.txt"]), angular.module("placeholders.img", []).directive("phImg", function () {
    return{restrict: "A", scope: {dimensions: "@phImg"}, link: function (e, t, n) {
        function s() {
        ...
        e.$watch("dimensions", function () {
            ...
            e.size = {w: n[1], h: n[2]}, t.prop("title", e.dimensions), t.prop("alt", e.dimensions), r = o(), t.prop("tagName") === "IMG" ? t.prop("src", r) : t.css("background-image", 'url("' + r + '")')
        })
    }}
    ...
    return{createSentence: function (n) {
        var r, i;
    ...
    return{restrict: "EA", controller: ["$scope", "$element", "$attrs", function (t, n, r) {
        function o() {
            var t;
